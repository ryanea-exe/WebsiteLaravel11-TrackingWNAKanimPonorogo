...
<div class="space-y-6">
    ...
    <div class="space-y-2">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 drop-shadow-sm">
            Data Kabupaten {{ ucfirst($wilayah) }}
            @isset($jenis)
                <span class="text-lg md:text-xl font-normal text-emerald-600 ml-2">({{ strtoupper($jenis) }})</span>
            @else
                <span class="text-lg md:text-xl font-normal text-blue-600 ml-2">(Semua Data)</span>
            @endisset
        </h1>
        <p class="text-gray-600 text-base max-w-xl leading-relaxed">
            Daftar lengkap Warga Negara Asing di {{ ucfirst($wilayah) }}
        </p>
    </div>
    ...
    <div class="glass rounded-2xl shadow-xl border border-gray-200 transition-all duration-300 hover:shadow-2xl overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-6 pb-4 border-b border-gray-200/50">
                ...
                <form method="GET" action="" class="flex items-center gap-3 bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-3 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-200 w-full lg:w-auto lg:flex-1 lg:max-w-md">
                    ...
                    >
                    @if(request('search'))
                        <a href="{{ request()->url() }}" class="text-gray-400 hover:text-gray-600 transition-colors p-1 -m-1 rounded-lg hover:bg-gray-200/50">
                ...
                <table class="w-full text-sm border-separate border-spacing-y-2 uppercase">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white/70 backdrop-blur-md hover:bg-white transition-all rounded-xl shadow-sm hover:shadow-md">
                            ...
                            <!-- ALAMAT -->
                            <td class="px-6 py-4 text-gray-600 max-w-[150px]">
...
<div class="pt-6 border-t border-gray-200/50 flex flex-col sm:flex-row sm:justify-end gap-4">
            <a href="{{ route('wna.wilayah', ['wilayah' => $wilayah]) }}"
